        ...
        <header className="bg-white border-b border-gray-300 fixed top-0 left-0 z-10 w-full">
            <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 lg:px-8">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <Link href="/profile" className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                        Профіль
                    </Link>
                </div>
            </nav>
